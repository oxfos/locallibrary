# Generated by Django 2.0.6 on 2018-07-06 19:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_name', models.CharField(choices=[('English', 'English'), ('German', 'German'), ('Spanish', 'Spanish'), ('Chinese', 'Chinese'), ('French', 'French')], help_text='Language of the book', max_length=100, verbose_name='Language')),
            ],
        ),
        migrations.AddField(
            model_name='book',
